...
int pin12 = 12;  //Variable que controla el led externo mediante el pin 12 del ESP32CAM
...
void setup() {
  ...
  pinMode (pin12, OUTPUT);// Se configura el pin como salida
  digitalWrite (pin12, LOW);// Se comienza con el led apagado
...
void loop() {
  ...
  digitalWrite (pin12, HIGH); // encender led externo
  ...
  digitalWrite (pin12, LOW); //apagar led externo
